...
import { compileExpression, expressionToJavaScript, parametersAt, sampleProject, validateProject } from '../src/model';
...
describe('expression evaluator', () => {
  ...
  it('handles right-associative powers and unary values', () => {
